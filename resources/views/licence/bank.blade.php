...
@section('content')
    <div class="row">
        <div class="col-md-12 grid-margin">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="font-weight-bold mb-0">السداد عن طريق البنك  <small><i class="ti-angle-left"></i> <a target="_blank" href="{{ asset('') }}">الرئيسية</a></small></h4>
                </div>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    @else
                        <form class="forms-sample" method="POST" action="{{ route('licence.bankPaymet') }}" >
                            @csrf
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h3 class="card-title"> رسوم المساحات 
                    </h3>
                    <div class="table-responsive">
                        <table class="table table-hover">
